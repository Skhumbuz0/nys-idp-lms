...
L2L_MODULES = [
    {
        ...
        "submodules": [
            {"number": "1.1", "title": "The Building Blocks of the Brain", "content_html": """
                <h3>The Building Blocks of the Brain — Neurons, Axons, Dendrites, and Synapses</h3>
                ...
                <p><strong>Real-World Example:</strong> When a learner practices multiplying numbers or conjugating verbs, electrical signals repeatedly fire across specific synaptic pathways. The first time a student encounters a new mathematical concept, the pathway is faint and weak. With repeated practice, the connection physically thickens, allowing signals to travel effortlessly.</p>
            """},
            {"number": "1.2", "title": "Brain Modes — Focused vs. Diffuse Thinking", "content_html": """
                <h3>Brain Modes — Focused vs. Diffuse Thinking & The Salvador Dalí / Edison Metaphor</h3>
                <p><strong>Detailed Explanation:</strong> The brain operates in two fundamentally distinct neural modes: <strong>Focused Mode</strong> and <strong>Diffuse Mode</strong>. Focused mode uses tightly spaced "pinball bumpers" across established neural pathways in the prefrontal cortex, ideal for analyzing familiar problems. Diffuse mode uses widely spaced bumpers across resting-state networks (the default mode network), allowing the mind to wander and connect distant neural nodes. You cannot be in both modes simultaneously for the same topic. When stuck on a difficult problem, staying in focused mode causes the brain to slither back into old, comfortable pathways rather than creating new ones.</p>
                <p><strong>Real-World Example:</strong> Historical figures like Salvador Dalí and Thomas Edison harnessed the diffuse mode. When stuck on a complex invention, Edison would sit in a chair holding ball bearings over a brass plate and let himself drift off to sleep. As his hand relaxed and the balls clattered onto the plate, he woke up, retrieving the creative, diffuse insights his brain had generated while relaxed.</p>
            """},
            {"number": "1.3", "title": "Memory Architecture — Working vs. Long-Term Memory", "content_html": """
                <h3>Memory Architecture — Working Memory (4 Slots) vs. Long-Term Memory</h3>
                ...
                <p><strong>Real-World Example:</strong> When a novice driver first learns to reverse a car, their 4 working memory slots are overloaded: checking side mirrors, modulating the clutch, turning the wheel, and looking behind. After weeks of practice, these separate actions consolidate into a single "car reversing chunk," freeing working memory to listen to the radio or navigate.</p>
            """},
            {"number": "1.4", "title": "Brain Maintenance — Sleep & Synaptic Mortar", "content_html": """
                <h3>Brain Maintenance — Sleep, Waste Clearance, and Synaptic Mortar</h3>
                <p><strong>Detailed Explanation:</strong> Sleep is an active, essential phase of learning. During waking hours, metabolic activity generates toxic byproducts (metabolites) that accumulate between brain cells. When you sleep, brain cells shrink slightly, allowing cerebrospinal fluid to wash away these metabolic toxins like a "synaptic janitor". Furthermore, sleep allows the brain to review daytime lessons, drying the "synaptic mortar" between neural bricks and sprouting new dendritic spines overnight.</p>
            ...
            """},
            {"number": "1.5", "title": "Neurogenesis & Brain Fertilizer — BDNF", "content_html": """
                <h3>Neurogenesis & Brain Fertilizer — Exercise and BDNF</h3>
    ...
    },
    {
        ...
        "submodules": [
            {"number": "2.1", "title": "Learning Orientations — Surface, Deep, Strategic", "content_html": """
                <h3>Learning Orientations — Surface, Deep, and Strategic Approaches</h3>
            ...
            """},
            {"number": "2.2", "title": "Locus of Control — Creator vs. Victim Language", "content_html": """
                <h3>Locus of Control — Creator vs. Victim Language</h3>
                <p><strong>Detailed Explanation:</strong> <strong>Locus of Control</strong> reflects the degree to which learners believe they control their academic outcomes. <strong>Victims</strong> possess an External Locus of Control, blaming external factors ("The lecturer expects too much", "I don't have time") and feeling helpless. <strong>Creators</strong> possess an Internal Locus of Control, using proactive language ("This module is demanding, so I will dedicate more time and seek help") to take responsibility for their progress.</p>
            ...
            """},
            {"number": "2.3", "title": "Multiple Intelligences & Learning Audits", "content_html": """
                <h3>Multiple Intelligences & Personal Learning Audits</h3>
                ...
                <p><strong>Real-World Example:</strong> A student with high Bodily/Kinesthetic intelligence learns history better by pacing while reciting notes or acting out historical events, whereas a Spatial/Visual learner builds detailed mind maps and color-coded diagrams.</p>
            """},
            {"number": "2.4", "title": "The Johari Window — Self-Awareness", "content_html": """
                <h3>The Johari Window — Self-Awareness through Feedback</h3>
            ...
            """},
            {"number": "2.5", "title": "The 4 Study Environment Domains", "content_html": """
                <h3>The 4 Study Environment Domains — Human, Non-Human, Spiritual, Internal</h3>
                <p><strong>Detailed Explanation:</strong> Learning environment design spans four distinct domains: 1) <em>Human Environment:</em> Support from family, housemates, and study groups. 2) <em>Non-Human Environment:</em> Physical study space, lighting, desk setup, and noise control. 3) <em>Spiritual Environment:</em> Core values, purpose, and connection to broader life goals. 4) <em>Internal Environment:</em> Self-belief, emotional regulation, and stress management.</p>
        ...
        "quiz": [
            {"q": "A student reads a biology chapter by highlighting every third sentence and memorizing definitions word-for-word. Which approach is this?", "options": ["Deep Learning", "Strategic Learning", "Surface Learning", "Metacognitive Mastery"], "correct": 2},
            ...
            {"q": "A learner who believes their exam failure was caused by 'unlucky questions' exhibits which orientation?", "options": ["Strong Internal Locus of Control", "Deep Learning Orientation", "External Locus of Control", "High Self-Efficacy"], "correct": 2},
    ...
    },
    {
        ...
        "submodules": [
            {"number": "3.1", "title": "Active Recall vs. The Fluency Illusion", "content_html": """
                <h3>Active Recall vs. The Fluency Illusion</h3>
            ...
            """},
            {"number": "3.2", "title": "Spaced Repetition — Beating the Forgetting Curve", "content_html": """
                <h3>Spaced Repetition — Beating the Ebbinghaus Forgetting Curve</h3>
            ...
            """},
            {"number": "3.3", "title": "Interleaving — Building Cognitive Agility", "content_html": """
                <h3>Interleaving — Building Cognitive Agility</h3>
            ...
            """},
            {"number": "3.4", "title": "Elaboration & Chunking", "content_html": """
                <h3>Elaboration & Chunking — Connecting New Ideas to Schemas</h3>
                <p><strong>Detailed Explanation:</strong> <strong>Elaboration</strong> is the process of asking <em>Why</em> and using the 5 W's and 1 H (Who, What, When, Where, Why, How) to connect new information to existing mental schemas. <strong>Chunking</strong> compresses complex networks of details into unified mental ribbons, allowing working memory to process high-level concepts effortlessly.</p>
            ...
            """},
            {"number": "3.5", "title": "Dual Coding & Concrete Examples", "content_html": """
                <h3>Dual Coding & Concrete Examples — Visual Doodling and Analogies</h3>
        ...
        "quiz": [
            ...
            {"q": "Which activity represents Higher-Order Learning?", "options": ["Reciting a definition word-for-word.", "Creating a relatable analogy that explains an abstract process.", "Matching terms to definitions.", "Highlighting dates in history."], "correct": 1}
        ]
    },
    {
        "code": "L2L-M4", "title": "Module 4: Plan Your Learning", "icon": "📅",
        "submodules": [
            {"number": "4.1", "title": "The 60/30/10 Rule (EFT Process)", "content_html": """
                <h3>The 60/30/10 Rule (EFT Process)</h3>
            ...
            """},
            {"number": "4.2", "title": "Eisenhower Matrix — Protecting Quadrant 2", "content_html": """
                <h3>Eisenhower Matrix — Protecting Quadrant 2</h3>
            ...
            """},
            {"number": "4.3", "title": "SMART Goal Setting & Regression Analysis", "content_html": """
                <h3>SMART Goal Setting & Regression Analysis</h3>
            ...
            """},
            {"number": "4.4", "title": "Study Time Allocation & Master Scheduling", "content_html": """
                <h3>Study Time Allocation & Master Scheduling</h3>
            ...
            """},
            {"number": "4.5", "title": "Household & Family Negotiation Framework", "content_html": """
                <h3>The Household & Family Negotiation Framework</h3>
        ...
        "quiz": [
            ...
            {"q": "In the Eisenhower Matrix, which quadrant should learners aggressively protect?", "options": ["Quadrant 1 (Urgent & Important)", "Quadrant 2 (Not Urgent but Important)", "Quadrant 3 (Urgent & Not Important)", "Quadrant 4 (Not Urgent & Not Important)"], "correct": 1},
    ...
    },
    {
        ...
        "submodules": [
            {"number": "5.1", "title": "Neurobiology of Avoidance — Insular Cortex Pain", "content_html": """
                <h3>The Neurobiology of Avoidance — Insular Cortex Pain Activation</h3>
            ...
            """},
            {"number": "5.2", "title": "Internal vs. External Causes", "content_html": """
                <h3>Internal vs. External Causes of Procrastination</h3>
                <p><strong>Detailed Explanation:</strong> Procrastination stems from specific internal and external drivers. <em>Internal:</em> Fear of failure, perfectionism, task aversion, low self-efficacy, and self-handicapping. <em>External:</em> Poor study environments, ambiguous assignment instructions, or unrefined deadlines.</p>
            ...
            """},
            {"number": "5.3", "title": "The 5-Minute Start Rule & Zeigarnik Effect", "content_html": """
                <h3>The 5-Minute Start Rule & The Zeigarnik Effect</h3>
            ...
            """},
            {"number": "5.4", "title": "Process Focus & The Pomodoro Technique", "content_html": """
                <h3>Process Focus & The Pomodoro Technique</h3>
            ...
            """},
            {"number": "5.5", "title": "The STAR Method & Reframing Mistakes", "content_html": """
                <h3>The STAR Method & Reframing Mistakes</h3>
    ...
    },
    {
        ...
        "submodules": [
            {"number": "6.1", "title": "The Leitner 5-Box Flashcard System", "content_html": """
                <h3>The Leitner 5-Box Flashcard System</h3>
            ...
            """},
            {"number": "6.2", "title": "The Method of Loci & Memory Palaces", "content_html": """
                <h3>The Method of Loci & Memory Palaces</h3>
            ...
            """},
            {"number": "6.3", "title": "Peg Systems, Rhyme Keys, and Acronyms", "content_html": """
                <h3>Peg Systems, Rhyme Keys, and Acronyms</h3>
            ...
            """},
            {"number": "6.4", "title": "Chaining, Linking, & Mnemonic Exaggeration", "content_html": """
                <h3>Chaining, Linking, & Mnemonic Exaggeration</h3>
            ...
            """},
            {"number": "6.5", "title": "Spaced Revision Calendars", "content_html": """
                <h3>Spaced Revision Calendars & Long-Term Memory Maintenance</h3>
    ...
    },
    {
        ...
        "submodules": [
            {"number": "7.1", "title": "The Shewhart Cycle (PDSA)", "content_html": """
                <h3>The Shewhart Cycle (PDSA — Plan, Do, Study, Act)</h3>
            ...
            """},
            {"number": "7.2", "title": "Active Reading Systems — SQ3R", "content_html": """
                <h3>Active Reading Systems — SQ3R & Surveying</h3>
            ...
            """},
            {"number": "7.3", "title": "The Cornell Method & The 5 R's", "content_html": """
                <h3>High-Impact Note-Taking — The Cornell Method & The 5 R's</h3>
                <p><strong>Detailed Explanation:</strong> Note-taking should follow Professor Walter Pauk's <strong>5 R's</strong>: 1) <em>Record:</em> Capture key concepts and main ideas during lectures. 2) <em>Reduce:</em> Summarize notes in a left-hand cue column. 3) <em>Recite:</em> Cover notes and recite concepts from cues in your own words. 4) <em>Reflect:</em> Think deeply about practical applications and implications. 5) <em>Review:</em> Perform weekly active reviews.</p>
            ...
            """},
            {"number": "7.4", "title": "Post-Exam Diagnostic Error Triage", "content_html": """
                <h3>Post-Exam Diagnostic Error Triage</h3>
            ...
            """},
            {"number": "7.5", "title": "Exam-Day Mindset & Managing Anxiety", "content_html": """
                <h3>Exam-Day Mindset & Managing Testing Anxiety</h3>
    ...
    },
    {
        ...
        "submodules": [
            {"number": "8.1", "title": "The Feynman Technique", "content_html": """
                <h3>The Feynman Technique — Teaching to a 10-Year-Old</h3>
            ...
            """},
            {"number": "8.2", "title": "Metacognitive Teach-Back & Gap Analysis", "content_html": """
                <h3>Metacognitive Teach-Back & Gap Analysis</h3>
            ...
            """},
            {"number": "8.3", "title": "Bloom's Cognitive Taxonomy", "content_html": """
                <h3>Bloom's Cognitive Taxonomy — Moving Up the Staircase</h3>
            ...
            """},
            {"number": "8.4", "title": "Krathwohl's Affective Taxonomy", "content_html": """
                <h3>Krathwohl's Affective Taxonomy & Value Internalisation</h3>
            ...
            """},
            {"number": "8.5", "title": "Thorndike's Laws of Learning", "content_html": """
                <h3>Thorndike's Laws of Learning & Self-Assessment Systems</h3>
        ...
        "quiz": [
            {"q": "What is the primary objective of Step 2 in the Feynman Technique?", "options": ["To memorize definitions faster.", "To instantly expose hidden gaps where you rely on unparsed technical jargon.", "To shorten sleep requirements.", "To eliminate study groups."], "correct": 1},
